...
<head>
<style type="text/css">
@font-face { font-family: Military; src :url('/ci/Maparmy.ttf');}
.mil{font-family:Military;font-size:22px;}
</style>
  ...
  #themap {width:33%;border:1px solid blue;height:400px;float:left;}
	...
	#army li , #enemy li, #building .bui{float:left;}
	#building .bui, #battle .bui{position:relative;width:30px;text-align:center;}
...
<script>function Sync(arg){
	...
	var theArgs = {}
		...
		that = this;
		  $.ajax(
		    {url: "/ci/index.php/game/fetch/"+last_seq,
		    	type:"POST",
		    	data:theArgs,
...
function doit(type){
	...
	$.ajax({url: "/ci/index.php/game/add/",
		type: "POST",
		data:{chats:mychat},
		success:function(data, textstatus){}
	});
...
<span class="mil">
!"</span>
<a href="/ci/index.php/game/logout"/>logout</a>
...
<form onsubmit="doit(false);return false;" id="chatform" method="post">
...
<fieldset>
<legend>Army
</legend><div id="army" class='mil'></div></fieldset>
<fieldset>
<legend>Building
</legend><div id="building"></div></fieldset>
<fieldset>
<legend>Chats
</legend><div id="chats"></div></fieldset>
<fieldset>
<legend>Gold
</legend><div id="gold"></div></fieldset>
<fieldset>
<legend>Mines
</legend><div id="mines"></div></fieldset>
<fieldset>
<legend>Factories
